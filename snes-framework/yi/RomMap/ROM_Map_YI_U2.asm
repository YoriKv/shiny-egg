...
macro YI_GlobalAssemblySettings()
	...
	!Define_Global_ApplyDefaultPatches = !FALSE
	...
	!Define_Global_BaseROMMD5Hash = "ce1e3e33b6e39d37b43d7de599f9e785"
...
; v1.4 hook macros. YI compiles each SPC700/SuperFX source file into its own .bin
; (the original-game upload format), driven by !PathToFile passed via the assemble bat.

macro YI_LoadSPC700ROMMap()
	incsrc "../!PathToFile"
endmacro
